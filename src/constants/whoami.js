...
<div class="whoami-glass-card">
  ...
  <div class="whoami-section">
    <p>My technical toolkit includes Python, SQL, R, and Tableau, along with hands-on experience in large language models (<span class="command-link" data-command="skills" style="color: #5abb9a; cursor: pointer; text-decoration: underline;">Type Skills or S for more information</span>). I've applied AI to automate workflows, analyze media, and create interactive applications.</p>
  </div>
  <div class="whoami-section">
