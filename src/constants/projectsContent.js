      ...
      >
        ...
        <div style={{ width: '100%', marginBottom: 16, borderRadius: 12, overflow: 'hidden', background: '#181818', height: 200, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          {fauxWebImage ? (
            ...
            <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: project.title === 'HN-Digest' ? '#000' : project.title === 'Disproving WOWII Conjectures 63 & 85 with Agentic Loops' ? '#fff' : 'transparent' }}>
              <img
                ...
                style={{ width: '100%', height: '100%', objectFit: (project.title === 'HN-Digest' || project.title === 'Disproving WOWII Conjectures 63 & 85 with Agentic Loops') ? 'contain' : 'cover', objectPosition: project.title === 'Megaphone' ? 'top' : 'center', display: 'block', borderRadius: 12 }}
              />
            </div>
          ) : null}
        </div>
                  ...
                  {project.title === 'Backdooms' ? (
                    ...
                    <div
                      style={{
                        ...
                        border: '1.5px solid rgba(90,187,154,0.18)',
                        boxShadow: '0 2px 16px 0 rgba(90,187,154,0.10)',
                        background: project.title === 'HN-Digest' ? '#000' : project.title === 'Disproving WOWII Conjectures 63 & 85 with Agentic Loops' ? '#fff' : '#181818',
                    ...
                    >
                      <img
                        ...
                        style={{
                          width: '100%',
                          height: '100%',
                          objectFit: (project.title === 'HN-Digest' || project.title === 'Disproving WOWII Conjectures 63 & 85 with Agentic Loops') ? 'contain' : 'cover',
                          objectPosition: project.title === 'Megaphone' ? 'top' : 'center',
                          display: 'block',
                        }}
                      />
                    </div>
                  ) : (['Claurst', 'Reference', 'Silverilla', 'DOOMme', 'GitHub View Counter', 'ThisWebsiteIsNotOnline', 'ORCUS', 'Free Deep Research', 'Books Re-imagined', 'MEOW', 'CottagOS', 'SecondYou', 'PrayGo', 'PicoGPT', 'TREAT', 'Sweeta', 'Strongy'].includes(project.title)) ? (
                    <div
                      style={{
                        marginBottom: 16,
                        borderRadius: 12,
