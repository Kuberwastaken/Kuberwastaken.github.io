            ...
            {col.map((project, idx) => (
              ...
              >
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  ) : (['Reference', 'Silverilla', 'DOOMme', 'GitHub View Counter', 'ThisWebsiteIsNotOnline', 'ORCUS', 'Free Deep Research', 'Books Re-imagined', 'MEOW', 'CottagOS', 'SecondYou', 'PrayGo', 'PicoGPT', 'TREAT', 'Sweeta', 'Strongy'].includes(project.title)) ? (
                    <div
                      style={{
                        marginBottom: 16,
                        borderRadius: 12,
